...
This is why I developed a handy tool that takes two colors and interpolates the values, generating the exact steps for a common TailwindCSS palette. You can try it out [here](https://bagger-ui.vercel.app/generator/palette).

![BaggerUI Generator](https://i.imgur.com/C99bj6w.png)

One general use case is to just pick a **very light color** and a **very dark color** of similar hue and let the computer do the rest. Copy the output generated in the [BaggerUI generator](https://bagger-ui.vercel.app/generatorgenerator/palette) and paste it in your `tailwind.config.js` file.
