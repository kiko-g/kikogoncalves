...
One general use case is to just pick a **very light color** and a **very dark color** of similar hue and let the computer do the rest. Copy the output generated in the [BagrUI generator](https://bagger-ui.vercel.app/generator) and paste it in your `tailwind.config.js` file.
