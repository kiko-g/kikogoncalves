...
This is why I developed a handy tool that takes two colors and interpolates the values, generating the exact steps for a common TailwindCSS palette. You can try it out [here](https://bagr-ui.vercel.app/generator).
