...
export const article = {
  ...
  date: '2023-05-20',
  title: 'Why I fell in love with TailwindCSS',
  description: `I bet web design will never bother you again. Tailwind has been a game changer for me. Ever since I started using Tailwind my ambition and belief in creating web interfaces has increased tremendously.`,
}
...
const Socials = () => {
  return (
    <div className="flex flex-wrap items-center justify-center gap-1 text-gray-400 md:mt-0 dark:text-gray-300">
      {socials
