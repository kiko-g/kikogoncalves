...
export const article = {
  ...
  description: `I bet web design will never bother you again. Tailwind has been a game changer for me. I must share why I believe Tailwind CSS is the best and most flexible CSS tooling out there, pretty much useful in any scenario, considering you're building a new app.`,
}
